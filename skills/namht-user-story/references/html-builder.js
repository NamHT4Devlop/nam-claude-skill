...
<div class="app">
  ...
  <div class="epic-hero">
    ...
    <div class="epic-meta">📅 Generated: ${esc(data.generatedAt)} · Project: ${esc(data.projectName)} · Auto Spec extension</div>
  </div>
...
${body}
<hr>
<p class="meta">Generated by Auto Spec extension · ${esc(new Date().toLocaleString('en-US'))}</p>
</div>
</body>
</html>`;
}
