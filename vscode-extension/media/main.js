...
const ACTIONS = [
  ...
  A('namht-port', 'build', '🔁', 'Port to another stack', 'Rails+GraphQL → Spring Boot, contract + behavior preserved (golden-test verified).', [one('scope', 'What to port (source → target stack, endpoint set)', 'Rails+GraphQL → Spring Boot/MyBatis; all GraphQL + these 3-5 REST APIs: …')], v => v.scope, true),
